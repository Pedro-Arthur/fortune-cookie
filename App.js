...
export default function App() {
  ...
  return (
    <View style={styles.container} >
      ...
      {click ? (
        <Image
          source={require('./src/assets/biscoitoAberto.png')}
          style={styles.img}
        />
      ) : (
        <Image
          source={require('./src/assets/biscoito.png')}
          style={styles.img}
        />
      )}
      ...
      <TouchableOpacity style={styles.button} onPress={() => crackerCookie()}>
